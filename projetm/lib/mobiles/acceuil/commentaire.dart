...
class PostDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String histoireId = post['id'] ?? '';  // Vérifie si post['id'] est null
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            if (FirebaseAuth.instance.currentUser?.uid == commenterId ||
                                                userDoc['role'] == 'admin' ||
                                                userDoc['role'] == 'partner') // Affiche le bouton "Supprimer" uniquement pour l'auteur ou l'admin/partenaire
                                              TextButton(
                                                onPressed: () async {
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (commentText.isNotEmpty) {
                          final String currentUserId = FirebaseAuth.instance.currentUser?.uid ?? 'inconnu';
                          final DocumentSnapshot currentUserDoc = await FirebaseFirestore.instance
                              .collection('users')
                              .doc(currentUserId)
                              .get();
                          final String userName = currentUserDoc['nom'] ?? 'Nom non disponible';
